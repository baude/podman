...
We view this Github repository as an upstream repository for development
and the latest Podman version.
...
You are welcome to replicate the bug with upstream code and report that.
