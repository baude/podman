...
// #### Example
// ~~~
// $ varlink call -m unix:/run/podman/io.containers.podman/io.containers.podman.Ping
// {
//   "ping": {
//     "message": "OK"
//   }
...
func (m Ping_methods) Send(c *varlink.Connection, flags uint64) (func() (StringResponse, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.Ping", nil, flags)
	if err != nil {
		return nil, err
	}
...
func (m GetVersion_methods) Send(c *varlink.Connection, flags uint64) (func() (Version, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.GetVersion", nil, flags)
	if err != nil {
		return nil, err
	}
...
func (m GetInfo_methods) Send(c *varlink.Connection, flags uint64) (func() (PodmanInfo, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.GetInfo", nil, flags)
	if err != nil {
		return nil, err
	}
...
func (m ListContainers_methods) Send(c *varlink.Connection, flags uint64) (func() ([]ListContainerData, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.ListContainers", nil, flags)
	if err != nil {
		return nil, err
	}
...
func (m GetContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (ListContainerData, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.GetContainer", in, flags)
	if err != nil {
		return nil, err
	}
...
// #### Example
// ~~~
// $ varlink call unix:/run/podman/io.containers.podman/io.containers.podman.CreateContainer '{"create": {"image": "alpine"}}'
// {
...
func (m CreateContainer_methods) Send(c *varlink.Connection, flags uint64, create_in_ Create) (func() (string, uint64, error), error) {
	...
	receive, err := c.Send("io.containers.podman.CreateContainer", in, flags)
	if err != nil {
		return nil, err
	}
...
func (m InspectContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.InspectContainer", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ string, flags uint64, err error) {
...
// #### Example
// ~~~
// $ varlink call -m unix:/run/podman/io.containers.podman/io.containers.podman.ListContainerProcesses '{"name": "135d71b9495f", "opts": []}'
// {
//   "container": [
...
func (m ListContainerProcesses_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, opts_in_ []string) (func() ([]string, uint64, error), error) {
	...
	receive, err := c.Send("io.containers.podman.ListContainerProcesses", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ []string, flags uint64, err error) {
...
func (m GetContainerLogs_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() ([]string, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.GetContainerLogs", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ []string, flags uint64, err error) {
...
func (m ListContainerChanges_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (ContainerChanges, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.ListContainerChanges", in, flags)
	if err != nil {
		return nil, err
	}
...
func (m ExportContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, path_in_ string) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	in.Path = path_in_
	receive, err := c.Send("io.containers.podman.ExportContainer", in, flags)
	if err != nil {
		return nil, err
	}
...
// #### Example
// ~~~
// $ varlink call -m unix:/run/podman/io.containers.podman/io.containers.podman.GetContainerStats '{"name": "c33e4164f384"}'
// {
//   "container": {
//     "block_input": 0,
//     "block_output": 0,
...
func (m GetContainerStats_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (ContainerStats, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.GetContainerStats", in, flags)
	if err != nil {
		return nil, err
	}
...
func (m ResizeContainerTty_methods) Send(c *varlink.Connection, flags uint64) (func() (NotImplemented, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.ResizeContainerTty", nil, flags)
	if err != nil {
		return nil, err
	}
...
func (m StartContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.StartContainer", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ string, flags uint64, err error) {
...
// #### Error
// ~~~
// $ varlink call -m unix:/run/podman/io.containers.podman/io.containers.podman.StopContainer '{"name": "135d71b9495f", "timeout": 5}'
// {
...
func (m StopContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, timeout_in_ int64) (func() (string, uint64, error), error) {
	...
	receive, err := c.Send("io.containers.podman.StopContainer", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ string, flags uint64, err error) {
...
func (m RestartContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, timeout_in_ int64) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	in.Timeout = timeout_in_
	receive, err := c.Send("io.containers.podman.RestartContainer", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ string, flags uint64, err error) {
...
func (m KillContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, signal_in_ int64) (func() (string, uint64, error), error) {
	...
	receive, err := c.Send("io.containers.podman.KillContainer", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ string, flags uint64, err error) {
...
func (m UpdateContainer_methods) Send(c *varlink.Connection, flags uint64) (func() (NotImplemented, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.UpdateContainer", nil, flags)
	if err != nil {
		return nil, err
	}
	return func() (notimplemented_out_ NotImplemented, flags uint64, err error) {
...
func (m RenameContainer_methods) Send(c *varlink.Connection, flags uint64) (func() (NotImplemented, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.RenameContainer", nil, flags)
	if err != nil {
		return nil, err
	}
	return func() (notimplemented_out_ NotImplemented, flags uint64, err error) {
...
func (m PauseContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.PauseContainer", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ string, flags uint64, err error) {
...
func (m UnpauseContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.UnpauseContainer", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ string, flags uint64, err error) {
...
func (m AttachToContainer_methods) Send(c *varlink.Connection, flags uint64) (func() (NotImplemented, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.AttachToContainer", nil, flags)
	if err != nil {
		return nil, err
	}
	return func() (notimplemented_out_ NotImplemented, flags uint64, err error) {
...
// #### Example
// ~~~
// $ varlink call -m unix:/run/io.containers.podman/io.containers.podman.GetAttachSockets '{"name": "b7624e775431219161"}'
// {
//   "sockets": {
...
func (m GetAttachSockets_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (Sockets, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.GetAttachSockets", in, flags)
	if err != nil {
		return nil, err
	}
...
func (m WaitContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (int64, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.WaitContainer", in, flags)
	if err != nil {
		return nil, err
	}
...
// #### Example
// ~~~
// $ varlink call -m unix:/run/podman/io.containers.podman/io.containers.podman.RemoveContainer '{"name": "62f4fd98cb57"}'
// {
...
func (m RemoveContainer_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, force_in_ bool) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	in.Force = force_in_
	receive, err := c.Send("io.containers.podman.RemoveContainer", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (container_out_ string, flags uint64, err error) {
...
func (m DeleteStoppedContainers_methods) Send(c *varlink.Connection, flags uint64) (func() ([]string, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.DeleteStoppedContainers", nil, flags)
	if err != nil {
		return nil, err
	}
...
func (m ListImages_methods) Send(c *varlink.Connection, flags uint64) (func() ([]ImageInList, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.ListImages", nil, flags)
	if err != nil {
		return nil, err
	}
...
func (m GetImage_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (ImageInList, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.GetImage", in, flags)
	if err != nil {
		return nil, err
	}
...
func (m BuildImage_methods) Send(c *varlink.Connection, flags uint64, build_in_ BuildInfo) (func() (BuildResponse, uint64, error), error) {
	...
	in.Build = build_in_
	receive, err := c.Send("io.containers.podman.BuildImage", in, flags)
	if err != nil {
		return nil, err
	}
...
func (m CreateImage_methods) Send(c *varlink.Connection, flags uint64) (func() (NotImplemented, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.CreateImage", nil, flags)
	if err != nil {
		return nil, err
	}
	return func() (notimplemented_out_ NotImplemented, flags uint64, err error) {
...
func (m InspectImage_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.InspectImage", in, flags)
	if err != nil {
		return nil, err
	}
...
func (m HistoryImage_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() ([]ImageHistory, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.HistoryImage", in, flags)
	if err != nil {
		return nil, err
	}
...
func (m PushImage_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, tag_in_ string, tlsverify_in_ bool) (func() (string, uint64, error), error) {
	...
	receive, err := c.Send("io.containers.podman.PushImage", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (image_out_ string, flags uint64, err error) {
...
func (m TagImage_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, tagged_in_ string) (func() (string, uint64, error), error) {
	...
	receive, err := c.Send("io.containers.podman.TagImage", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (image_out_ string, flags uint64, err error) {
...
// #### Example
// ~~~
// varlink call -m unix:/run/podman/io.containers.podman/io.containers.podman.RemoveImage '{"name": "registry.fedoraproject.org/fedora", "force": true}'
// {
...
func (m RemoveImage_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, force_in_ bool) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	in.Force = force_in_
	receive, err := c.Send("io.containers.podman.RemoveImage", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (image_out_ string, flags uint64, err error) {
...
func (m SearchImage_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, limit_in_ int64) (func() ([]ImageSearch, uint64, error), error) {
	...
	in.Name = name_in_
	in.Limit = limit_in_
	receive, err := c.Send("io.containers.podman.SearchImage", in, flags)
	if err != nil {
		return nil, err
	}
...
func (m DeleteUnusedImages_methods) Send(c *varlink.Connection, flags uint64) (func() ([]string, uint64, error), error) {
	receive, err := c.Send("io.containers.podman.DeleteUnusedImages", nil, flags)
	if err != nil {
		return nil, err
	}
...
func (m Commit_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, image_name_in_ string, changes_in_ []string, author_in_ string, message_in_ string, pause_in_ bool) (func() (string, uint64, error), error) {
	...
	in.Pause = pause_in_
	receive, err := c.Send("io.containers.podman.Commit", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (image_out_ string, flags uint64, err error) {
...
func (m ImportImage_methods) Send(c *varlink.Connection, flags uint64, source_in_ string, reference_in_ string, message_in_ string, changes_in_ []string) (func() (string, uint64, error), error) {
	...
	in.Message = message_in_
	in.Changes = []string(changes_in_)
	receive, err := c.Send("io.containers.podman.ImportImage", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (image_out_ string, flags uint64, err error) {
...
func (m ExportImage_methods) Send(c *varlink.Connection, flags uint64, name_in_ string, destination_in_ string, compress_in_ bool, tags_in_ []string) (func() (string, uint64, error), error) {
	...
	receive, err := c.Send("io.containers.podman.ExportImage", in, flags)
	if err != nil {
		return nil, err
	}
	return func() (image_out_ string, flags uint64, err error) {
...
// #### Example
// ~~~
// $ varlink call -m unix:/run/podman/io.containers.podman/io.containers.podman.PullImage '{"name": "registry.fedoraproject.org/fedora"}'
// {
...
func (m PullImage_methods) Send(c *varlink.Connection, flags uint64, name_in_ string) (func() (string, uint64, error), error) {
	...
	in.Name = name_in_
	receive, err := c.Send("io.containers.podman.PullImage", in, flags)
	if err != nil {
		return nil, err
	}
...
type iocontainerspodmanInterface interface {
...
func (c *VarlinkCall) ReplyImageNotFound(name_ string) error {
	...
	out.Name = name_
	return c.ReplyError("io.containers.podman.ImageNotFound", &out)
}
...
func (c *VarlinkCall) ReplyContainerNotFound(name_ string) error {
	...
	out.Name = name_
	return c.ReplyError("io.containers.podman.ContainerNotFound", &out)
}
...
func (c *VarlinkCall) ReplyErrorOccurred(reason_ string) error {
	...
	out.Reason = reason_
	return c.ReplyError("io.containers.podman.ErrorOccurred", &out)
}
...
func (c *VarlinkCall) ReplyRuntimeError(reason_ string) error {
	...
	out.Reason = reason_
	return c.ReplyError("io.containers.podman.RuntimeError", &out)
}
...
func (s *VarlinkInterface) Ping(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.Ping")
}

// GetVersion returns a Version structure describing the libpod setup on their
// system.
func (s *VarlinkInterface) GetVersion(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.GetVersion")
}

// GetInfo returns a [PodmanInfo](#PodmanInfo) struct that describes podman and its host such as storage stats,
// build information of Podman, and system-wide registries.
func (s *VarlinkInterface) GetInfo(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.GetInfo")
}

// ListContainers returns a list of containers in no particular order.  There are
// returned as an array of ListContainerData structs.  See also [GetContainer](#GetContainer).
func (s *VarlinkInterface) ListContainers(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.ListContainers")
}
...
func (s *VarlinkInterface) GetContainer(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.GetContainer")
}
...
func (s *VarlinkInterface) CreateContainer(c VarlinkCall, create_ Create) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.CreateContainer")
}
...
func (s *VarlinkInterface) InspectContainer(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.InspectContainer")
}
...
func (s *VarlinkInterface) ListContainerProcesses(c VarlinkCall, name_ string, opts_ []string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.ListContainerProcesses")
}
...
func (s *VarlinkInterface) GetContainerLogs(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.GetContainerLogs")
}
...
func (s *VarlinkInterface) ListContainerChanges(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.ListContainerChanges")
}
...
func (s *VarlinkInterface) ExportContainer(c VarlinkCall, name_ string, path_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.ExportContainer")
}
...
func (s *VarlinkInterface) GetContainerStats(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.GetContainerStats")
}

// This method has not be implemented yet.
func (s *VarlinkInterface) ResizeContainerTty(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.ResizeContainerTty")
}
...
func (s *VarlinkInterface) StartContainer(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.StartContainer")
}
...
func (s *VarlinkInterface) StopContainer(c VarlinkCall, name_ string, timeout_ int64) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.StopContainer")
}
...
func (s *VarlinkInterface) RestartContainer(c VarlinkCall, name_ string, timeout_ int64) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.RestartContainer")
}
...
func (s *VarlinkInterface) KillContainer(c VarlinkCall, name_ string, signal_ int64) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.KillContainer")
}

// This method has not be implemented yet.
func (s *VarlinkInterface) UpdateContainer(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.UpdateContainer")
}

// This method has not be implemented yet.
func (s *VarlinkInterface) RenameContainer(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.RenameContainer")
}
...
func (s *VarlinkInterface) PauseContainer(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.PauseContainer")
}
...
func (s *VarlinkInterface) UnpauseContainer(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.UnpauseContainer")
}

// This method has not be implemented yet.
func (s *VarlinkInterface) AttachToContainer(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.AttachToContainer")
}
...
func (s *VarlinkInterface) GetAttachSockets(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.GetAttachSockets")
}
...
func (s *VarlinkInterface) WaitContainer(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.WaitContainer")
}
...
func (s *VarlinkInterface) RemoveContainer(c VarlinkCall, name_ string, force_ bool) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.RemoveContainer")
}

// DeleteStoppedContainers will delete all containers that are not running. It will return a list the deleted
// container IDs.  See also [RemoveContainer](RemoveContainer).
func (s *VarlinkInterface) DeleteStoppedContainers(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.DeleteStoppedContainers")
}

// ListImages returns an array of ImageInList structures which provide basic information about
// an image currently in storage.  See also [InspectImage](InspectImage).
func (s *VarlinkInterface) ListImages(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.ListImages")
}

// GetImage returns a single image in an [ImageInList](#ImageInList) struct.  You must supply an image name as a string.
// If the image cannot be found, an [ImageNotFound](#ImageNotFound) error will be returned.
func (s *VarlinkInterface) GetImage(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.GetImage")
}
...
func (s *VarlinkInterface) BuildImage(c VarlinkCall, build_ BuildInfo) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.BuildImage")
}

// This function is not implemented yet.
func (s *VarlinkInterface) CreateImage(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.CreateImage")
}
...
func (s *VarlinkInterface) InspectImage(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.InspectImage")
}
...
func (s *VarlinkInterface) HistoryImage(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.HistoryImage")
}
...
func (s *VarlinkInterface) PushImage(c VarlinkCall, name_ string, tag_ string, tlsverify_ bool) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.PushImage")
}

// TagImage takes the name or ID of an image in local storage as well as the desired tag name.  If the image cannot
// be found, an [ImageNotFound](#ImageNotFound) error will be returned; otherwise, the ID of the image is returned on success.
func (s *VarlinkInterface) TagImage(c VarlinkCall, name_ string, tagged_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.TagImage")
}
...
func (s *VarlinkInterface) RemoveImage(c VarlinkCall, name_ string, force_ bool) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.RemoveImage")
}
...
func (s *VarlinkInterface) SearchImage(c VarlinkCall, name_ string, limit_ int64) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.SearchImage")
}

// DeleteUnusedImages deletes any images not associated with a container.  The IDs of the deleted images are returned
// in a string array.
func (s *VarlinkInterface) DeleteUnusedImages(c VarlinkCall) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.DeleteUnusedImages")
}
...
func (s *VarlinkInterface) Commit(c VarlinkCall, name_ string, image_name_ string, changes_ []string, author_ string, message_ string, pause_ bool) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.Commit")
}

// ImportImage imports an image from a source (like tarball) into local storage.  The image can have additional
// descriptions added to it using the message and changes options. See also [ExportImage](ExportImage).
func (s *VarlinkInterface) ImportImage(c VarlinkCall, source_ string, reference_ string, message_ string, changes_ []string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.ImportImage")
}
...
func (s *VarlinkInterface) ExportImage(c VarlinkCall, name_ string, destination_ string, compress_ bool, tags_ []string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.ExportImage")
}
...
func (s *VarlinkInterface) PullImage(c VarlinkCall, name_ string) error {
	return c.ReplyMethodNotImplemented("io.containers.podman.PullImage")
}
...
func (s *VarlinkInterface) VarlinkDispatch(call varlink.Call, methodname string) error {
	switch methodname {
	case "Ping":
		return s.iocontainerspodmanInterface.Ping(VarlinkCall{call})

	case "GetVersion":
		return s.iocontainerspodmanInterface.GetVersion(VarlinkCall{call})

	case "GetInfo":
		return s.iocontainerspodmanInterface.GetInfo(VarlinkCall{call})

	case "ListContainers":
		return s.iocontainerspodmanInterface.ListContainers(VarlinkCall{call})
	...
	case "GetContainer":
		...
		return s.iocontainerspodmanInterface.GetContainer(VarlinkCall{call}, in.Name)
	...
	case "CreateContainer":
		...
		return s.iocontainerspodmanInterface.CreateContainer(VarlinkCall{call}, in.Create)
	...
	case "InspectContainer":
		...
		return s.iocontainerspodmanInterface.InspectContainer(VarlinkCall{call}, in.Name)
	...
	case "ListContainerProcesses":
		...
		return s.iocontainerspodmanInterface.ListContainerProcesses(VarlinkCall{call}, in.Name, []string(in.Opts))
	...
	case "GetContainerLogs":
		...
		return s.iocontainerspodmanInterface.GetContainerLogs(VarlinkCall{call}, in.Name)
	...
	case "ListContainerChanges":
		...
		return s.iocontainerspodmanInterface.ListContainerChanges(VarlinkCall{call}, in.Name)
	...
	case "ExportContainer":
		...
		return s.iocontainerspodmanInterface.ExportContainer(VarlinkCall{call}, in.Name, in.Path)
	...
	case "GetContainerStats":
		...
		return s.iocontainerspodmanInterface.GetContainerStats(VarlinkCall{call}, in.Name)

	case "ResizeContainerTty":
		return s.iocontainerspodmanInterface.ResizeContainerTty(VarlinkCall{call})
	...
	case "StartContainer":
		...
		return s.iocontainerspodmanInterface.StartContainer(VarlinkCall{call}, in.Name)
	...
	case "StopContainer":
		...
		return s.iocontainerspodmanInterface.StopContainer(VarlinkCall{call}, in.Name, in.Timeout)
	...
	case "RestartContainer":
		...
		return s.iocontainerspodmanInterface.RestartContainer(VarlinkCall{call}, in.Name, in.Timeout)
	...
	case "KillContainer":
		...
		return s.iocontainerspodmanInterface.KillContainer(VarlinkCall{call}, in.Name, in.Signal)

	case "UpdateContainer":
		return s.iocontainerspodmanInterface.UpdateContainer(VarlinkCall{call})

	case "RenameContainer":
		return s.iocontainerspodmanInterface.RenameContainer(VarlinkCall{call})
	...
	case "PauseContainer":
		...
		return s.iocontainerspodmanInterface.PauseContainer(VarlinkCall{call}, in.Name)
	...
	case "UnpauseContainer":
		...
		return s.iocontainerspodmanInterface.UnpauseContainer(VarlinkCall{call}, in.Name)

	case "AttachToContainer":
		return s.iocontainerspodmanInterface.AttachToContainer(VarlinkCall{call})
	...
	case "GetAttachSockets":
		...
		return s.iocontainerspodmanInterface.GetAttachSockets(VarlinkCall{call}, in.Name)
	...
	case "WaitContainer":
		...
		return s.iocontainerspodmanInterface.WaitContainer(VarlinkCall{call}, in.Name)
	...
	case "RemoveContainer":
		...
		return s.iocontainerspodmanInterface.RemoveContainer(VarlinkCall{call}, in.Name, in.Force)

	case "DeleteStoppedContainers":
		return s.iocontainerspodmanInterface.DeleteStoppedContainers(VarlinkCall{call})

	case "ListImages":
		return s.iocontainerspodmanInterface.ListImages(VarlinkCall{call})
	...
	case "GetImage":
		...
		return s.iocontainerspodmanInterface.GetImage(VarlinkCall{call}, in.Name)
	...
	case "BuildImage":
		...
		return s.iocontainerspodmanInterface.BuildImage(VarlinkCall{call}, in.Build)

	case "CreateImage":
		return s.iocontainerspodmanInterface.CreateImage(VarlinkCall{call})
	...
	case "InspectImage":
		...
		return s.iocontainerspodmanInterface.InspectImage(VarlinkCall{call}, in.Name)
	...
	case "HistoryImage":
		...
		return s.iocontainerspodmanInterface.HistoryImage(VarlinkCall{call}, in.Name)
	...
	case "PushImage":
		...
		return s.iocontainerspodmanInterface.PushImage(VarlinkCall{call}, in.Name, in.Tag, in.Tlsverify)
	...
	case "TagImage":
		...
		return s.iocontainerspodmanInterface.TagImage(VarlinkCall{call}, in.Name, in.Tagged)
	...
	case "RemoveImage":
		...
		return s.iocontainerspodmanInterface.RemoveImage(VarlinkCall{call}, in.Name, in.Force)
	...
	case "SearchImage":
		...
		return s.iocontainerspodmanInterface.SearchImage(VarlinkCall{call}, in.Name, in.Limit)

	case "DeleteUnusedImages":
		return s.iocontainerspodmanInterface.DeleteUnusedImages(VarlinkCall{call})
	...
	case "Commit":
		...
		return s.iocontainerspodmanInterface.Commit(VarlinkCall{call}, in.Name, in.Image_name, []string(in.Changes), in.Author, in.Message, in.Pause)
	...
	case "ImportImage":
		...
		return s.iocontainerspodmanInterface.ImportImage(VarlinkCall{call}, in.Source, in.Reference, in.Message, []string(in.Changes))
	...
	case "ExportImage":
		...
		return s.iocontainerspodmanInterface.ExportImage(VarlinkCall{call}, in.Name, in.Destination, in.Compress, []string(in.Tags))
	...
	case "PullImage":
		...
		return s.iocontainerspodmanInterface.PullImage(VarlinkCall{call}, in.Name)
...
type VarlinkInterface struct {
	iocontainerspodmanInterface
}

func VarlinkNew(m iocontainerspodmanInterface) *VarlinkInterface {
