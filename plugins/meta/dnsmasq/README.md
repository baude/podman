...
## Usage
The dnsmasq plugin can be enabled in the cni network configuration file.
...
reboot.  Therefore, files are stored in `/run/containers/cni/dnsmasq`. The plugin knows will recreate the necessary
